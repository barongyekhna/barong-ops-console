"""Database runtime owned exclusively by the C19 record service."""
...
class UTCDateTime(TypeDecorator[datetime]):
    """Preserve timezone awareness even when SQLite drops tzinfo."""
...
def build_engine(database_url: str) -> Engine:
    ...
    options: dict[str, Any] = {
        "pool_pre_ping": True,
        # SQLAlchemy exception strings and engine logs must never interpolate
        # the chat body or any other bound value.
