...
MODULE_ADAPTER_CONTRACTS_V1: tuple[dict[str, Any], ...] = (
    ...
    _adapter(
        ...
        description="User management adapter contract metadata.",
        adapter_status="sealed",
        lifecycle="sealed",
        supported_surfaces=(
            "navigation",
        ...
        capabilities=(
            ...
            _capability(
                ...
                description="Declare user lifecycle actions.",
                required_permission="users.manage",
        ...
        actions=(
            ...
            _action(
                ...
                description="Declare user lifecycle contract.",
                required_permission="users.manage",
                risk_level="high",
    ...
    _adapter(
        ...
        description="Permission management adapter contract.",
        adapter_status="sealed",
        lifecycle="sealed",
        supported_surfaces=(
            "navigation",
        ...
        capabilities=(
            ...
            _capability(
                ...
                description="Declare permission assignment actions.",
        ...
        actions=(
            ...
            _action(
                ...
                description="Declare permission assignment contract.",
                required_permission="permissions.manage",
                risk_level="critical",
    ...
    _adapter(
        ...
        description=(
            "I-series image system adapter boundary. I owns AI image "
            "generation, image editing, media library storage, and API-level "
            "handoff to K-series."
        ),
        adapter_status="sealed",
        lifecycle="sealed",
        ...
        pages=(
            _page(
                ...
                status="sealed",
                unavailable_behavior="show_unavailable",
                component_ref="builtin.i_image_system_workspace",
                data_contract_refs=("i.image_system.asset.v1",),
                action_refs=(
                    "i.image_system.generate",
                    "i.image_system.edit",
                ),
            ),
        ),
        ...
        api_bindings=(
            _api(
                api_key="i.image_system.generate",
                module_key="i.image_system",
                api_namespace="/i",
                path="/i/images/generate",
                method="POST",
                status="sealed",
                required_permission="i.image_system.execute",
            ),
            _api(
                api_key="i.image_system.edit",
                module_key="i.image_system",
                api_namespace="/i",
                path="/i/images/edit",
                method="POST",
            ...
            _api(
                api_key="i.image_system.media_library",
                module_key="i.image_system",
                api_namespace="/i",
                path="/i/media-library",
                method="GET",
                status="sealed",
                required_permission="i.image_system.read",
            ),
        ...
        capabilities=(
            _capability(
                capability_key="i.image_system.create",
                module_key="i.image_system",
                display_name="Generate and edit images",
                description="Run I-series prompt enhancement and image creation.",
                required_permission="i.image_system.execute",
                surfaces=("module_page", "status_widget"),
            ),
        ),
        actions=(
            _action(
                action_key="i.image_system.generate",
                module_key="i.image_system",
                capability_key="i.image_system.create",
                display_name="Generate I image candidates",
                description="Generate removable final image candidates.",
                required_permission="i.image_system.execute",
                risk_level="medium",
                operation_log_action="i.image_system.generate",
                execution_type="no_op",
                status="sealed",
                requires_execution_provider=True,
            ),
            _action(
                action_key="i.image_system.edit",
                module_key="i.image_system",
                capability_key="i.image_system.create",
                display_name="Edit I image candidates",
                description="Edit images with temporary reference uploads.",
                required_permission="i.image_system.execute",
                risk_level="medium",
                operation_log_action="i.image_system.edit",
                execution_type="no_op",
                status="sealed",
                requires_execution_provider=True,
            ),
        ...
        action_contracts=(
            ...
            _action_contract(
                action_key="i.image_system.edit",
                input_contract="i.image_system.edit.input.v1",
                output_contract="i.image_system.output.v1",
                required_permission="i.image_system.execute",
                risk_level="medium",
                operation_log_action="i.image_system.edit",
        ...
        input_contracts=(
            _input_contract(
                ...
                optional_fields=("style_config", "aspect_ratio", "generation_count"),
            ),
            _input_contract(
                contract_key="i.image_system.edit.input.v1",
                action_key="i.image_system.edit",
        ...
        output_contracts=(
            _output_contract(
                ...
                action_key="i.image_system.generate",
                safe_summary_fields=("candidate_count", "image_prompt_enhanced", "status"),
            ),
        ),
        permission_bindings=(
            _permission_binding(
            ...
            _permission_binding(
                ...
                module_key="i.image_system",
                used_by="action:i.image_system.generate",
                surface="action_panel",
                risk_level="medium",
            ),
            _permission_binding(
                ...
                module_key="i.image_system",
                used_by="surface:i.image_system.media_library",
                surface="module_page",
                risk_level="medium",
            ),
        ),
