...
MODULE_MANIFESTS_V1: tuple[dict[str, Any], ...] = (
    ...
    _manifest(
        ...
        description=(
            "Hidden staged global C19 communication control runtime. This "
            "manifest governs only durable C19 control metadata; external "
            "chat content and assets remain unconfigured and fail closed."
        ),
        category="core",
        status="planned",
        lifecycle="designed",
        ...
        required_permissions=("c19.directory.read",),
        permission_manifest=(
            _permission(
                module_key="communication.im",
