...
EXECUTION_PROVIDER_CONTRACTS_V1: tuple[dict[str, Any], ...] = (
    _provider(
        provider_key="k.product_knowledge.prompt.provider",
        provider_type="future_live_provider",
        provider_status="live_ready",
        provider_readiness="live_ready",
        lifecycle="live_ready",
        display_name="K Product Prompt Provider",
        description="K product prompt execution contract gated by module control and API key binding.",
        supported_execution_modes=("live", "future_live"),
        supported_action_types=("run",),
        ...
        unavailable_reason="key_binding_required",
        can_request_execution=False,
    ),
    _provider(
        provider_key="k.product_knowledge.serp.provider",
        provider_type="future_live_provider",
        provider_status="live_ready",
        provider_readiness="live_ready",
        lifecycle="live_ready",
        display_name="K SERP Keyword Provider",
        description="K SERP keyword execution contract gated by module control and API key binding.",
        supported_execution_modes=("live", "future_live"),
        supported_action_types=("run",),
        module_key="k.product_knowledge",
        adapter_key="k.product_knowledge.adapter",
        ...
        requires_execution_provider=True,
        requires_secret=True,
        unavailable_reason="serp_key_binding_required",
        can_request_execution=False,
    ),
    _provider(
        provider_key="k.product_knowledge.ai_enrich.provider",
        provider_type="future_live_provider",
        provider_status="live_ready",
        provider_readiness="live_ready",
        lifecycle="live_ready",
        display_name="K AI Enrichment Provider",
        description="K DeepSeek or AI enrichment execution contract gated by module control and API key binding.",
        supported_execution_modes=("live", "future_live"),
        supported_action_types=("generate",),
        module_key="k.product_knowledge",
        adapter_key="k.product_knowledge.adapter",
        ...
        requires_execution_provider=True,
        requires_secret=True,
        unavailable_reason="ai_key_binding_required",
        can_request_execution=False,
    ),
    _provider(
        provider_key="k.product_knowledge.risk_filter.provider",
        provider_type="future_live_provider",
        provider_status="live_ready",
        provider_readiness="live_ready",
        lifecycle="live_ready",
        display_name="K Risk Filtering Provider",
        description="K risk keyword detection and filtering contract gated by module control, approval, and API key binding.",
        supported_execution_modes=("live", "future_live"),
        supported_action_types=("review",),
        module_key="k.product_knowledge",
        adapter_key="k.product_knowledge.adapter",
        ...
        requires_secret=True,
        unavailable_reason="risk_filter_key_binding_required",
        can_request_execution=False,
    ),
    _provider(
