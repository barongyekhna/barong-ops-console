...
BASE_PERMISSION_REGISTRY_SEED: tuple[PermissionDefinition, ...] = (
    ...
    {
        "permission_key": "c19.directory.read",
        "module_key": "communication.im",
        "category": "core",
        "action": "read",
        "label": "Read communication directory",
        "description": "View safe C19 directory and contact control metadata.",
        "risk_level": RISK_LEVEL_MEDIUM,
        "menu_policy": MENU_POLICY_SHOW_LOCKED,
    },
    {
        "permission_key": "c19.conversations.read",
        "module_key": "communication.im",
        "category": "core",
        "action": "read",
        "label": "Read conversations",
        "description": "View authorized C19 conversation control metadata.",
        "risk_level": RISK_LEVEL_MEDIUM,
        "menu_policy": MENU_POLICY_SHOW_LOCKED,
    },
    {
        ...
        "action": "send",
        "label": "Send messages",
        "description": "Submit messages through a configured C19 record store.",
        "risk_level": RISK_LEVEL_MEDIUM,
        "menu_policy": MENU_POLICY_SHOW_LOCKED,
    },
    {
        "permission_key": "c19.friends.manage",
        "module_key": "communication.im",
        "category": "core",
        "action": "manage",
        "label": "Manage friends",
        "description": "Create and manage C19 friend relationships.",
        "risk_level": RISK_LEVEL_MEDIUM,
        "menu_policy": MENU_POLICY_SHOW_LOCKED,
    },
    {
        "permission_key": "c19.groups.create",
        "module_key": "communication.im",
        "category": "core",
        "action": "create",
        "label": "Create groups",
        "description": "Create C19 communication groups within the authorized control plane.",
        "risk_level": RISK_LEVEL_MEDIUM,
        "menu_policy": MENU_POLICY_SHOW_LOCKED,
    },
    {
        "permission_key": "c19.groups.manage",
        "module_key": "communication.im",
        "category": "core",
        "action": "manage",
        "label": "Manage groups",
        "description": "Manage C19 group metadata, membership, and lifecycle.",
        "risk_level": RISK_LEVEL_HIGH,
        "menu_policy": MENU_POLICY_SHOW_LOCKED,
    },
    {
        "permission_key": "c19.moments.read",
        "module_key": "communication.im",
        "category": "core",
        "action": "read",
        "label": "Read moments",
        "description": "View authorized C19 moments control metadata.",
        "risk_level": RISK_LEVEL_MEDIUM,
        "menu_policy": MENU_POLICY_SHOW_LOCKED,
    },
    {
        "permission_key": "c19.moments.publish",
        "module_key": "communication.im",
        "category": "core",
        "action": "publish",
        "label": "Publish moments",
        "description": "Publish C19 moments through a configured record and asset store.",
        "risk_level": RISK_LEVEL_MEDIUM,
        "menu_policy": MENU_POLICY_SHOW_LOCKED,
    },
    {
        "permission_key": "c19.attachments.upload",
        "module_key": "communication.im",
        "category": "core",
        "action": "upload",
        "label": "Upload attachments",
        "description": "Upload C19 attachments through a configured asset store.",
        "risk_level": RISK_LEVEL_HIGH,
        "menu_policy": MENU_POLICY_SHOW_LOCKED,
    },
    {
        "permission_key": "c19.moderation.manage",
        "module_key": "communication.im",
        "category": "core",
        "action": "manage",
        "label": "Manage communication moderation",
        "description": "Manage high-risk C19 moderation controls and decisions.",
        "risk_level": RISK_LEVEL_CRITICAL,
        "menu_policy": MENU_POLICY_SHOW_LOCKED,
    },
    {
