...
DEFAULT_IMAGE_MAX_BYTES = 32 * 1024 * 1024
DEFAULT_FILE_MAX_BYTES = 200 * 1024 * 1024
DEFAULT_THUMBNAIL_MAX_BYTES = 2 * 1024 * 1024
HARD_THUMBNAIL_MAX_BYTES = 8 * 1024 * 1024
DEFAULT_OWNER_RESERVED_FILES = 2_000
DEFAULT_OWNER_RESERVED_BYTES = 20 * 1024 * 1024 * 1024
DEFAULT_GLOBAL_RESERVED_FILES = 100_000
DEFAULT_GLOBAL_RESERVED_BYTES = 100 * 1024 * 1024 * 1024
