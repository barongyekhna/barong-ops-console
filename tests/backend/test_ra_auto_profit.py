        ...
        connection.execute(
            text(
                ...
                INSERT INTO products_rw (
                  ...
                  category, category_path, price, state, skill_score, updated_at
                )
                VALUES
                  (
                    'B0TABLE001', 'US', '露营桌', 'Folding Camping Table',
                    '折叠露营桌', 'https://m.media-amazon.com/images/I/table.jpg',
                    '户外桌椅', '户外 > 露营 > 桌子',
                    39.99, 'rule_passed', 88, '2026-07-05T01:00:00'
                  ),
                  (
                    'B0STOVE001', 'US', '露营炉', 'Portable Camping Stove',
                    '便携式露营炉', 'https://m.media-amazon.com/images/I/stove.jpg',
                    '户外炉具', '户外 > 露营 > 炉具',
            ...
            text(
                ...
                VALUES
                  (
                    ...
                    '4人圆形餐桌', 'https://m.media-amazon.com/images/I/dining.jpg',
                  ...
                  (
                    ...
                    '防水餐桌布', 'https://m.media-amazon.com/images/I/cloth.jpg',
                    'Tablecloths',
                  ...
                  (
                    ...
                    '婚礼餐桌桌旗', 'https://m.media-amazon.com/images/I/runner.jpg',
                    'Table Runners',
