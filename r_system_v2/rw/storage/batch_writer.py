...
products_rw = sa.Table(
    ...
    sa.Column("title_zh_source", sa.Text),
    sa.Column("title_zh_updated_at", sa.DateTime(timezone=True)),
    sa.Column("image_url", sa.Text),
    sa.Column("fulfillment_method", sa.Text),
    sa.Column("lithium_battery_warning", sa.Boolean),
    ...
    sa.Column("margin_confidence", sa.Text),
...
def _product_row(result: PipelineResult) -> dict[str, Any]:
    ...
    return {
        ...
        "title_zh_source": product.title_zh_source,
        "title_zh_updated_at": _parse_datetime(product.title_zh_updated_at),
        "image_url": product.image_url,
        "fulfillment_method": product.fulfillment_method,
        "lithium_battery_warning": product.lithium_battery_warning,
        "brand": product.brand,
        ...
        "margin_source": product.margin_source,
        "margin_confidence": product.margin_confidence,
